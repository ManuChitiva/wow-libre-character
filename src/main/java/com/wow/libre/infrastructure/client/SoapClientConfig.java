...
public class SoapClientConfig {
    ...
    public Jaxb2Marshaller requestMarshaller() {
        ...
        marshaller.setContextPath("com.wow.libre.infrastructure.client.soap.xml"); // Paquete para las clases de solicitud
        return marshaller;
    }
    ...
    public Jaxb2Marshaller responseUnmarshaller() {
        ...
        unmarshaller.setContextPath("com.wow.libre.infrastructure.client.soap.xml.resp"); // Paquete para las clases de respuesta
        return unmarshaller;
    }
    @Bean
    public WebServiceTemplate webServiceTemplate(Jaxb2Marshaller requestMarshaller, Jaxb2Marshaller responseUnmarshaller) {
